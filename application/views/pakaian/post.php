      ...
      <div class="row">
        <div class="col-lg-11">
          <div class="p-5">
            ...
            <form class="user" method="POST" action="<?=base_url('admin/pakaian/save')?>">
              <div class="form-group mb-3">
                <label class="text-dark">Jenis Pakaian</label>
                <input type="text" class="form-control" placeholder="Jenis Pakaian..." name="nama" value="<?=set_value('nama') ?>">
